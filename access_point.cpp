...
FormField formFields[NUM_FORM_FIELDS] = {
    ...
    {"PingIPInput1",
     ...
     PREF_STRING,
     {.str_pref = appPrefs.config.pingIPs[0]},
     "",
     false},
    {"PingIPInput2",
     "Ping IP 2",
     ...
     VALIDATION_IP_ADDRESS,
     PREF_STRING,
     {.str_pref = appPrefs.config.pingIPs[1]},
     "",
     false},
    {"PingIPInput3",
     "Ping IP 3",
     ...
     VALIDATION_IP_ADDRESS,
     PREF_STRING,
     {.str_pref = appPrefs.config.pingIPs[2]},
     "",
     false},
    {"PingIPInput4",
     "Ping IP 4",
     ...
     VALIDATION_IP_ADDRESS,
     PREF_STRING,
     {.str_pref = appPrefs.config.pingIPs[3]},
     "",
     false},
    {"PingIPIndex",
     "Current Ping IP",
     ...
     VALIDATION_NONE,
     PREF_INT,
     {.int_pref = &appPrefs.config.curPingIPIndex},
     "",
     false},
    {"pingIntervalSec",
     "Ping Time [sec]",
     ...
     VALIDATION_NONE,
     PREF_INT,
     {.int_pref = &appPrefs.config.pingIntervalSec},
     "",
     false},
    {"PingSoundOn",
     "Ping Sound On",
     ...
     VALIDATION_NONE,
     PREF_BOOL,
     {.bool_pref = &appPrefs.config.pingSoundOn},
     "",
     false},
    {"AlertOn",
     "Alert On",
     ...
     VALIDATION_NONE,
     PREF_BOOL,
     {.bool_pref = &appPrefs.config.alertOn},
     "",
     false},
    {"logLevel",
     "Log Level",
...
<html>
<head>
    <title>Aethereal Echo Gauge Settings</title>
...
<script>
  ...
  for (int i = 0; i < numFields; ++i) {
    ...
    if (field.prefType == PREF_STRING) {
      ...
      DBGLOG(Debug, "field.id: %s, value: %s", field.id, field.pref.str_pref);
    } else if (field.prefType == PREF_BOOL) {
      DBGLOG(Debug, "field.pref.bool_pref: %s",
      ...
      // DBGLOG(Debug, "field.pref.int_pref: %d", *(field.pref.int_pref));
      script += "    " + String(field.id) + ".value = \"" +
